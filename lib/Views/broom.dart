...
class Broom extends StatefulWidget {
  const Broom({Key? key}) : super(key: key);

  @override
  State<Broom> createState() => _BroomState();
}

class _BroomState extends State<Broom> {
  ...
  Future<void> initializePlayer() async {
    _controller = VideoPlayerController.asset('assets/broom.mp4');
